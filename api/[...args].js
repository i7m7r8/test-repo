...
const manifest = {
  ...
  catalogs: [
    ...
    { type: "movie",  id: "ms_xxx",        name: "🔞 All (Uncensored)",   extra: [{ name: "search" }, { name: "skip" }] }
  ],
...
module.exports = async (req, res) => {
  ...
  if (cm) {
    ...
    try {
      ...
      const catMap   = { ms_hollywood: "207", ms_bollywood: "200", ms_tvshows: "205", ms_all_movie: "0", ms_all_series: "0", ms_xxx: "0" };
      const queryMap = { ms_hollywood: "movie", ms_bollywood: "hindi", ms_tvshows: "tv show", ms_all_movie: "top", ms_all_series: "top", ms_xxx: "" };
